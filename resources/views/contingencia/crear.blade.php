...
<h5>Emitir Factura en Contingencia</h5>
@if (session('error'))
...
<div class="card-body">
<form action="{{ route('contingencia.store') }}" method="POST">
@csrf
<div class="row mb-3">
<div class="col-md-4">
...
<a href="{{ route('contingencia.index') }}" class="btn btn-secondary">Cancelar</a>
</div>
</form>
</div>
</div>
